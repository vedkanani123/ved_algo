...
export default async function NewLicensePage() {
  await requireOwner();
  return <div className="app-shell"><ConsoleNav active="new" /><main className="main"><header className="topline"><div><p className="eyebrow">Registry / issue authority</p><h1>Issue a license</h1></div><p className="system-clock"><b>● MFA VERIFIED</b> &nbsp; SESSION S-92F1</p></header>
